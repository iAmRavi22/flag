...
const TwitterForm = () => {
  ...
  const twitterService = service?.filter(
    (services) =>
      services.name.includes("Twitter") || services.name.includes("𝐓𝐰𝐢𝐭𝐭𝐞𝐫")
  );
  ...
  const handleChange = async (e) => {
    ...
    object.quantity.includes("Followers") ? setBoole(true) : setBoole(false);
  };
  ...
  return (
    <>
      <div className="user-form form-box">
        {location?.state?.editType === "twitter" && (
          <p>You're editing a cart item</p>
        )}
        <form>
          <div className="form-group">
            <div className="input-box">
              <label htmlFor="user">Twitter Services</label>
              <select
                name="service"
            ...
            <div className="input-box">
              <label htmlFor="user">
                {!boole ? "Twitter Tweet Link" : "Twitter Username "}
              </label>
              <input
        ...
        <div className="example_name">
          ...
          <p>
            Enter your Twitter Username (starts with an "@" symbol). Your
            profile must be public.
          </p>
        </div>
        <p className="exp-text">
          <b>Twitter username example :</b> <span>@cristiano</span>
        </p>
...
// if( object.quantity.includes("Youtube Views" || "Youtube High Rentention Views"  || "Youtube Real Likes")){
//   setBoole("one")
//  }else if(object.quantity.includes("Youtube Short Views") ){
//     setBoole("two")
//  }else if(object.quantity.includes("Youtube Comment Likes") ){
//   setBoole("three")
// }else if(object.quantity.includes("Youtube Subscribers") ){
// setBoole("four")
